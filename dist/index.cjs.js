...
var require$$1$1 = require('async_hooks');
var require$$1$2 = require('os');
var require$$6$1 = require('fs');
...
var _tabbable2 = _interopRequireDefault$5(_tabbable);
...
var _exenv2 = _interopRequireDefault$4(_exenv);
...
var _warning2 = _interopRequireDefault$3(_warning);
...
var _reactDom$1 = require$$1__default['default'];

var _reactDom2$1 = _interopRequireDefault$1(_reactDom$1);
...
var ariaAppHider = _interopRequireWildcard$1(_ariaAppHider);
...
var isReact16 = _safeHTMLElement.canUseDOM && _reactDom2$1.default.createPortal !== undefined;
...
var getCreatePortal = function getCreatePortal() {
  return isReact16 ? _reactDom2$1.default.createPortal : _reactDom2$1.default.unstable_renderSubtreeIntoContainer;
};
...
var Modal$1 = function (_Component) {
  ...
  function Modal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$1(this, (_ref = Modal.__proto__ || Object.getPrototypeOf(Modal)).call.apply(_ref, [this].concat(args))), _this), _this.removePortal = function () {
      !isReact16 && _reactDom2$1.default.unmountComponentAtNode(_this.node);
...
Parameters.mergeParams = mergeParams;

var ParseRuntime = {};

Object.defineProperty(ParseRuntime, "__esModule", { value: true });
...
ParseRuntime.initParseRuntime = initParseRuntime;
...
function contextBind(ctx, cb) {
    ...
    if (async !== null) {
        var old = cb;
        cb = function() {
            var $_len = arguments.length + 2;var args = new Array($_len); for(var $_i = 2; $_i < $_len ; ++$_i) {args[$_i] = arguments[$_i  - 2];}            args[0] = old;
            args[1] = this;
...
ret.nodeSupportsAsyncResource = ret.isNode && (function() {
    ...
    try {
        var res = require$$1__default$1['default'].AsyncResource;
...
if (util$3.isNode && typeof MutationObserver === "undefined") {
    ...
    schedule$1 = util$3.isRecentNode
...
var notEnumerableProp = util$2.notEnumerableProp;
...
var util = util$4;
var getKeys = es5$3.exports.keys;
...
var AsyncResource = util.isNode && util.nodeSupportsAsyncResource ?
    require$$1__default$1['default'].AsyncResource : null;
...
join(
    Promise, PromiseArray, tryConvertToPromise, INTERNAL, async$1);
...
var bluebird_1$3 = bluebird;

var ProcessorLocal$1 = {};
...
Object.defineProperty(dataClean, "__esModule", { value: true });
var strip_bom_1 = __importDefault$6(stripBom);
/**
...
dataClean.prepareData = prepareData;
/**
...
Object.defineProperty(getEol, "__esModule", { value: true });
//return first eol found from a data chunk.
function default_1$1(data, param) {
    if (!param.eol && data) {
...
Object.defineProperty(fileline, "__esModule", { value: true });
var getEol_1$2 = __importDefault$5(getEol);
...
function stringToLines(data, param) {
    var eol = getEol_1$2.default(data, param);
    var lines = data.split(eol);
    var partial = lines.pop() || "";
    return { lines: lines, partial: partial };
}
fileline.stringToLines = stringToLines;
...
util.bufFromString = bufFromString;
...
util.filterArray = filterArray;
util.trimLeft = String.prototype.trimLeft ? function trimLeftNative(str) {
    return str.trimLeft();
} : function trimLeftRegExp(str) {
    return str.replace(/^\s+/, "");
};
util.trimRight = String.prototype.trimRight ? function trimRightNative(str) {
...
Object.defineProperty(rowSplit, "__esModule", { value: true });
var getEol_1$1 = __importDefault$4(getEol);
var util_1$1 = util;
        ...
        for (var i = 0, rowLen = rowArr.length; i < rowLen; i++) {
            ...
            if (!inquote) {
                ...
                if (this.isQuoteClose(e)) { //close double quote
                    ...
                    if (trim) {
                        quoteBuff = util_1$1.trimRight(quoteBuff);
                    }
                    row.push(quoteBuff);
                    quoteBuff = "";
                }
        ...
        while (lines.length) {
            ...
            if (row.closed || this.conv.parseParam.alwaysSplitAtEOL) {
                if (this.conv.parseRuntime.selectedColumns) {
                    csvLines.push(util_1$1.filterArray(row.cells, this.conv.parseRuntime.selectedColumns));
                }
                else {
                ...
                left = line + (getEol_1$1.default(line, this.conv.parseRuntime) || "\n");
            }
        }
...
Object.defineProperty(CSVError$1, "__esModule", { value: true });
var CSVError = /** @class */ (function (_super) {
    __extends$2(CSVError, _super);
...
Object.defineProperty(lineToJson, "__esModule", { value: true });
var CSVError_1$1 = __importDefault$3(CSVError$1);
var set_1 = __importDefault$3(set_1$1);
...
Object.defineProperty(ProcessorLocal$1, "__esModule", { value: true });
var Processor_1 = Processor$1;
var bluebird_1$2 = __importDefault$2(bluebird_1$3);
var dataClean_1 = dataClean;
var getEol_1 = __importDefault$2(getEol);
var fileline_1 = fileline;
var util_1 = util;
var rowSplit_1 = rowSplit;
var lineToJson_1 = __importDefault$2(lineToJson);
var CSVError_1 = __importDefault$2(CSVError$1);
var ProcessorLocal = /** @class */ (function (_super) {
    __extends$1(ProcessorLocal, _super);
        ...
        if (this.runtime.csvLineBuffer && this.runtime.csvLineBuffer.length > 0) {
            ...
            return this.process(buf, true)
                ...
                if (_this.runtime.csvLineBuffer && _this.runtime.csvLineBuffer.length > 0) {
                    return bluebird_1$2.default.reject(CSVError_1.default.unclosed_quote(_this.runtime.parsedLineNumber, _this.runtime.csvLineBuffer.toString()));
                }
                else {
                    return bluebird_1$2.default.resolve(res);
                }
            });
        }
        else {
            return bluebird_1$2.default.resolve([]);
        }
    };
    ...
    ProcessorLocal.prototype.processCSV = function (csv, finalChunk) {
        ...
        if (stringToLineResult.lines.length > 0) {
            ...
            if (runtime.preFileLineHook) {
                ...
                prom = bluebird_1$2.default.resolve(stringToLineResult.lines);
            }
    ...
    ProcessorLocal.prototype.runPreLineHook = function (lines) {
        var _this = this;
        return new bluebird_1$2.default(function (resolve, reject) {
...
ProcessorLocal$1.ProcessorLocal = ProcessorLocal;
...
var bluebird_1$1 = __importDefault$1(bluebird_1$3);
var os_1 = require$$1__default$2['default'];
...
Object.defineProperty(Converter$1, "__esModule", { value: true });
var stream_1 = require$$0__default['default'];
var Parameters_1 = Parameters;
var ParseRuntime_1 = ParseRuntime;
var bluebird_1 = __importDefault(bluebird_1$3);
// import { ProcessorFork } from "./ProcessFork";
var ProcessorLocal_1 = ProcessorLocal$1;
...
var _default = lib.default = FileInput;
...
const ModalFooter = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    title: "table-action-btns"
  }, /*#__PURE__*/React__default['default'].createElement("button", {
    onClick: closeModal,
    id: "close-modal-btn",
    title: "close-modal"
  }, "Close"), showSave && /*#__PURE__*/React__default['default'].createElement("button", {
    onClick: handleSave,
    id: "save-updates-btn",
    title: "save-updates"
  }, "Save"));
...
const EmptyState = () => {
  ...
  }, /*#__PURE__*/React__default['default'].createElement("h2", null, "Preview"), /*#__PURE__*/React__default['default'].createElement("p", null, "Select a csv file to upload and preview"));
};
...
const TableRow = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("tr", {
    title: "table-row",
    key: index
  }, Object.keys(row).slice(1).map((rowKey, idx) => /*#__PURE__*/React__default['default'].createElement("td", {
    key: idx
  }, row.editing ? /*#__PURE__*/React__default['default'].createElement("input", {
    title: "row-input",
    ...
    title: "row-text"
  }, row[rowKey]))), /*#__PURE__*/React__default['default'].createElement("td", null, row.editing ? /*#__PURE__*/React__default['default'].createElement("div", {
    title: "edit-actions"
  }, /*#__PURE__*/React__default['default'].createElement("button", {
    title: "action-save",
    ...
    title: "non-edit-actions"
  }, !editing && /*#__PURE__*/React__default['default'].createElement("button", {
    title: "action-edit",
...
const Table = ({
  ...
  const [editing, setEditing] = React$1.useState(false);
  const [rowToEdit, setRowToEdit] = React$1.useState({});
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, tableHeaders.length > 0 && /*#__PURE__*/React__default['default'].createElement("table", {
    title: "table"
  }, /*#__PURE__*/React__default['default'].createElement("thead", null, /*#__PURE__*/React__default['default'].createElement("tr", null, tableHeaders.map((header, idx) => /*#__PURE__*/React__default['default'].createElement("th", {
    key: idx
  }, header)), tableHeaders.length > 0 && /*#__PURE__*/React__default['default'].createElement("th", null, "..."))), /*#__PURE__*/React__default['default'].createElement("tbody", null, tableRows.map((row, idx) => /*#__PURE__*/React__default['default'].createElement(TableRow, {
    rowToEdit: rowToEdit,
    index: idx,
    key: idx,
    row: row,
    ...
    editing: editing
  }))))), tableHeaders.length === 0 && /*#__PURE__*/React__default['default'].createElement(EmptyState, null), /*#__PURE__*/React__default['default'].createElement(ModalFooter, {
...
var UploadModal = function UploadModal(_ref) {
  var _ref$buttonComponent = _ref.buttonComponent,
      buttonComponent = _ref$buttonComponent === void 0 ? null : _ref$buttonComponent,
      onSave = _ref.onSave;
  ...
  var _useState3 = React$1.useState([]),
      ...
      tableHeaders = _useState4[0],
      setTableHeaders = _useState4[1];
  ...
  var handleFileUpload = function handleFileUpload(e, results) {
  ...
  var csvReader = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(csv) {
      var result, data, i, tempItem, item, key;
    ...
    return function csvReader(_x2) {
      return _ref3.apply(this, arguments);
    };
  }();

  var createTableHeader = function createTableHeader(row) {
    var headers = [];
  ...
  var handleDelete = function handleDelete(index) {
    var tempData = _toConsumableArray(tableRows);
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    title: "upload-modal"
  }, buttonComponent ? /*#__PURE__*/React__default['default'].createElement("div", {
    title: "custom-init-button",
    onClick: openModal
  }, ' ', buttonComponent, ' ') : /*#__PURE__*/React__default['default'].createElement("button", {
    title: "default-init-button",
    onClick: openModal,
    className: "modal-open-btn"
  }, "Upload Files"), /*#__PURE__*/React__default['default'].createElement(Modal, {
    isOpen: modalIsOpen,
  ...
  }, "Choose File")))), /*#__PURE__*/React__default['default'].createElement(Table, {
    handleDelete: handleDelete,
